...
public class ChangePhoneNumberHandlerWhenSignUp extends JFrame implements ActionListener{
	private Button submit;
	private static JTextField newPhoneNumber;
	public ChangePhoneNumberHandlerWhenSignUp() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		submit.addActionListener(new ChangePhoneNumberWhenSignUp());
		cp.add(submit);
		setVisible(true);
	}
}
