...
public class SetAppointmentWindowSignUp implements ActionListener {
	 ...
	 */
	public SetAppointmentWindowSignUp() {
		initialize();
	}
	...
	public void actionPerformed(ActionEvent e) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SetAppointmentWindowSignUp window = new SetAppointmentWindowSignUp();
