...
import CalendarPackage.DayCalendar;
*/
...
public class DayCalendarTest {
	public static void main(String[] args) {
		 ...
		 */
		events.add(new CalendarEvent(LocalDate.of(2016, 11, 18), LocalTime.of(16, 00), LocalTime.of(16, 45),
				"Test 18/11 16:00-16:45", Color.BLUE));
