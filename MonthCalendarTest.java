...
public class MonthCalendarTest {
	public static void main(String[] args) {
		...
		/*
		 * events.add(new CalendarEvent(LocalDate.of(2016, 11, 11), LocalTime.of(14, 0),
		 * LocalTime.of(14, 20), "Test 11/11 14:00-14:20")); events.add(new
		 * CalendarEvent(LocalDate.of(2016, 11, 14), LocalTime.of(9, 0), LocalTime.of(9,
		 * 20), "Test 14/11 9:00-9:20")); events.add(new
		 ...
		 */
		events.add(new CalendarEvent(LocalDate.of(2018, 10, 22), LocalTime.of(16, 00), LocalTime.of(16, 45),
				"Test 18/11 16:00-16:45", Color.CYAN));

		events.add(new CalendarEvent(LocalDate.of(2018, 10, 22), LocalTime.of(14, 00), LocalTime.of(14, 45),
				"Test 18/11 16:00-16:45", Color.PINK));

		events.add(new CalendarEvent(LocalDate.of(2018, 10, 23), LocalTime.of(14, 00), LocalTime.of(14, 45),
				"Test 18/11 16:00-16:45", Color.GREEN));

		events.add(new CalendarEvent(LocalDate.of(2018, 12, 8), LocalTime.of(14, 00), LocalTime.of(14, 45),
				"Test 18/11 16:00-16:45", Color.GREEN));
