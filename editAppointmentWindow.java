...
public class editAppointmentWindow implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					editAppointmentWindow window = new editAppointmentWindow();
	...
	private void initialize() {
		...
		ArrayList<String> arraySchedule = databaseAction.showRepresentation(3);
		...
		*/
		...
		//First we delete that appointment from the database, and invoke the user to set a new appointment
		//editButton.addActionListener(new editAppointmentHandler());
		...
		editButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				databaseAction.cancelAppointmentAtIndex(3, des);
		...
		cancelButtonPanel.add(editButton);
