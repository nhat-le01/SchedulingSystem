...
public class WeekCalendarTest {
    public static void main(String[] args) {
	    ...
	    cale.set(Calendar.MONTH, 11);
	    cale.set(Calendar.DATE, 22);
	    cale.set(Calendar.HOUR_OF_DAY, 13);
    	...
    	int h = end.getHours();
    	int m = end.getMinutes();
    	int sh = start.getHours();
    	System.out.println(sh);
    	int sm = start.getMinutes();
       
        //events.add(new CalendarEvent(LocalDate.of(2016, 11, 11), LocalTime.of(14, 0), LocalTime.of(14, 20), "Test 11/11 14:00-14:20", Color.PINK));
       ...
       // events.add(new CalendarEvent(LocalDate.of(2016, 11, 18), LocalTime.of(16, 00), LocalTime.of(16, 45), "Test 18/11 16:00-16:45"));
        ...
        events.add(new CalendarEvent(LocalDate.of(year, month, date), LocalTime.of(sh, sm), LocalTime.of(h, m), "Test 18/11 16:00-16:45", Color.PINK));
        
        //events.add(new CalendarEvent(LocalDate.of(2018, 11, 23), LocalTime.of(14, 00), LocalTime.of(14, 45), "Test 18/11 16:00-16:45", Color.GREEN));
        
        //events.add(new CalendarEvent(LocalDate.of(2018, 11, 27), LocalTime.of(14, 00), LocalTime.of(14, 45), "Test 18/11 16:00-16:45", Color.GREEN));
...
public class WeekCalendarTest {
    public static void main(String[] args) {
	    ...
	    int sh = cal1.get(Calendar.HOUR_OF_DAY);
	    int sm =  cal1.get(Calendar.MINUTE);
    	...
    	events.add(new CalendarEvent(LocalDate.of(year,  month,  date), LocalTime.of(sh, sm), LocalTime.of(h,m), "demo appointment"));
        //events.add(new CalendarEvent(LocalDate.of(2016, 11, 11), LocalTime.of(14, 0), LocalTime.of(14, 20), "Test 11/11 14:00-14:20", Color.PINK));
       // events.add(new CalendarEvent(LocalDate.of(2016, 11, 14), LocalTime.of(9, 0), LocalTime.of(9, 20), "Test 14/11 9:00-9:20"));
       // events.add(new CalendarEvent(LocalDate.of(2016, 11, 15), LocalTime.of(12, 0), LocalTime.of(13, 20), "Test 15/11 12:00-13:20"));
        //events.add(new CalendarEvent(LocalDate.of(2016, 11, 16), LocalTime.of(9, 0), LocalTime.of(9, 20), "Test 16/11 9:00-9:20"));
       ...
       // events.add(new CalendarEvent(LocalDate.of(2018, 11, 22), LocalTime.of(16, 00), LocalTime.of(16, 45), "Test 18/11 16:00-16:45", Color.CYAN));

        //events.add(new CalendarEvent(LocalDate.of(2018, 11, 22), LocalTime.of(14, 00), LocalTime.of(14, 45), "Test 18/11 16:00-16:45", Color.PINK));
