...
public class editAppointmentHandler implements ActionListener {
	...
	private static JComboBox comboBox, comboBox_1, comboBox_2, comboBox_3, comboBox_4, comboBox_5, comboBox_6,
			comboBox_7, comboBox_8, comboBox_9;
	 ...
	 * Runnable() { public void run() { try { SetAppointmentWindow window = new
	 * SetAppointmentWindow(); window.frame.setVisible(true); } catch (Exception e)
	 * { e.printStackTrace(); } } }); }
	 **/
	...
	private void initialize() {
		...
		comboBox_2.setModel(new DefaultComboBoxModel(
				new String[] { "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025" }));
	...
	public void actionPerformed(ActionEvent e) {
		System.out.println("LKDF");
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					editAppointmentHandler window = new editAppointmentHandler();
